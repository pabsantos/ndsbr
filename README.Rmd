...
This is a basic example which shows you how to load NDS-BR data a calculate traveled distances. First, `nds_load_data` loads the sample from all NDS-BR files inside a specific folder, defined by the user. 
